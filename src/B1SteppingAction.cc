...
CheckFile1 << EventID << " " << PosX << " " << PosY << " " << PosZ << " " << KineticEnergy << " " << ParticleName << " " << Volume->GetName() << " " << ProcessName <<  " " << depositedEnergy << G4endl;
CheckFile1.close();
}
if (ParticleName == "gamma"){
std::ofstream CheckFile2;
CheckFile2.open("gamma_source.dat", std::ios::app);
CheckFile2 << EventID << " " << PosX << " " << PosY << " " << PosZ << " " << KineticEnergy << " " << ParticleName << " " << Volume->GetName() << " " << ProcessName <<  " " << depositedEnergy << G4endl;
CheckFile2.close();
}
if (ParticleName == "e-"){
std::ofstream CheckFile3;
CheckFile3.open("electron_source.dat", std::ios::app);
CheckFile3 << EventID << " " << PosX << " " << PosY << " " << PosZ << " " << KineticEnergy << " " << ParticleName << " " << Volume->GetName() << " " << ProcessName <<  " " << depositedEnergy << G4endl;
CheckFile3.close();
}
}
}
